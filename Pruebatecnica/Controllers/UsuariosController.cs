using Pruebatecnica.Business.Dtos.Usuarios;
...
using Pruebatecnica.ViewModels.Usuarios;
using System;
...
using Pruebatecnica.Business.Dtos;
            ...
            if (ModelState.IsValid)
            {
                ...
                if (resultado.Succeeded)
                {
                    ...
                    else if (rol.Contains("Cliente"))
                    {
                        ...
                        ViewBag.idcliente = _clienteService.ObtenerClientePorId(usuario.Id);
        ...
        public async Task<IActionResult> OlvidePassword(OlvidePasswordDto olvidePasswordDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (usuario != null)
                {
                    ...
                    mensaje.From = new MailAddress(_configuration["Mail"], "Fondo XYZ");
